...
const SCHOTTKY_DIODO_COLLECTION = new StrokeCollection([
 ...
 const ACTUADOR_LINEAR_NO_AMORTIGUACION = new StrokeCollection([
    new RectangleArray([0, 1], [1, 3], 1, DEFAULT_COLOR),
    new Line([1, 0], [1, 4], 1, DEFAULT_COLOR),
    new Line([2, 0], [2, 4], 1, DEFAULT_COLOR)
 ], DEFAULT_COLOR, 36)

 const ACTUADOR_LINEAR_AMORTIGUACION = new StrokeCollection([
    new RectangleArray([0, 1], [0.5, 3], 1, DEFAULT_COLOR),
    new RectangleArray([1.5, 1], [2, 3], 1, DEFAULT_COLOR),
    new Line([0.5, 0], [0.5, 4], 1, DEFAULT_COLOR),
    new Line([1.5, 0], [1.5, 4], 1, DEFAULT_COLOR),
    new Line([0.25, 4], [1.75, 0], 1, DEFAULT_COLOR)
 ], DEFAULT_COLOR, 37)

 const ACTUADOR_SENSOR_FC = new StrokeCollection([
    ...
    new Line([0.5,0.5],[0.5,1],1,DEFAULT_COLOR),

    new Arc([0.5, 1.25], 0.25, 0, 2*Math.PI, 1, DEFAULT_COLOR),
 ], DEFAULT_COLOR, 38)
...
const ACTUADOR_LINEAR_COLLECTION = [
    ["imgs/linear/sin.png", ACTUADOR_LINEAR_NO_AMORTIGUACION.clone().translate([1, 0])],
    ["imgs/linear/amortiguacion.png", ACTUADOR_LINEAR_AMORTIGUACION.clone().translate([1, 0])]
]

const ACTUADOR_LINEAR_SENSORES_COLLECTION = [
    ["", NONE_COLLECTION],
    ["imgs/ico/IcoSensor.png",SENSOR_COLLECTION.clone()],
    ["imgs/ico/IcoFc.png",ACTUADOR_SENSOR_FC.clone().translate([-1, -0.75])],
]
...
const MAGNETO_ADD = new StrokeCollection([
new RectangleArray([0, 0], [2, 4], 1, DEFAULT_COLOR),
new Line([0, 2], [2, 2], 1, DEFAULT_COLOR),
new Text([1, 3], 25, "I>", DEFAULT_COLOR, "center"),

new Line([0.75, 1.25], [0.75, 1.75], 2, DEFAULT_COLOR),
new Line([0.75, 1.25], [1.25, 1.25], 2, DEFAULT_COLOR),

new Line([0.75, 0.75], [0.75, 0.25], 2, DEFAULT_COLOR),
new Line([0.75, 0.75], [1.25, 0.75], 2, DEFAULT_COLOR),

new Line([1.25, 1.25], [1.25, 0.75], 2, DEFAULT_COLOR),

new Line([1, 0], [1, -1], 1, DEFAULT_COLOR),
new Line([0, -3], [1, -1], 1, DEFAULT_COLOR),
new Line([1, -4], [1, -3], 1, DEFAULT_COLOR),
new Line([.5, -2], [-.5, -2], 1 ,DEFAULT_COLOR),
